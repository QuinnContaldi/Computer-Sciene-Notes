...
- 2.
    ...
    **Transportation Planning**. An analytics professional is asked to plan the shipment of a product for the next quarter. She employs the following process:
    ...
    For each of the 12 distribution centers, she plots the quarterly demand for the product over the last three years.
    ...
    Describe the type of analytics being utilized in each of the three steps outlined above. LO 1
    
- 3.
    ![](Problem3.Png)
    **_Wall Street Journal_ Subscriber Characteristics**. A _Wall Street Journal_ subscriber survey asked a series of questions about subscriber characteristics and interests. State whether each of the following questions provides categorical or quantitative data. LO 2
